...
input_mode = st.radio("请选择你的出招方式：", ["📂 上传本地文件 (图片/视频)", "📷 开启摄像头拍照", "对战小游戏"], horizontal=True)
...
if input_mode == "📂 上传本地文件 (图片/视频)":
    ...
    mixed_buffer = st.file_uploader("📂 放入比赛截图或视频 (支持 jpg, png, mp4, avi, mov)", type=['jpg', 'jpeg', 'png', 'mp4', 'avi', 'mov'])
